...
export const MainContext = createContext<{
  ...
  setTestInstance: Dispatch<SetStateAction<TestInstance | null>>
} | null>(null);

function App() {
  const [testInstance, setTestInstance] = useState<TestInstance | null>(null);

  return (
    <MainContext value={{testInstance, setTestInstance}}>
