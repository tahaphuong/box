...
import { AlgoSolution, PlacementOption, type PlacementOptionType } from "@/models";
...
export interface GreedyPlacement<Item, SOL extends AlgoSolution> {
    ...
    checkThenAdd(item: Item, solution: SOL, indicatedPos: Position | null): boolean;
    removeBox(boxId: number): void;
    clone(updateFn?: (draft: GreedyPlacement<Item, SOL>) => void): GreedyPlacement<Item, SOL>;
